...
---@class gopls.GoDirArgs
---@field envvar_id string `go env` variable to read, e.g. "GOROOT"
---@field custom_subdir? string appended to the resolved directory, e.g. "/src"

---@param custom_args gopls.GoDirArgs
